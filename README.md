...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-b6o70hs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-b6o70hs.containers.anotherwebservice.com/
...
```
git clone git@github.com:aypop3/container-b6o70hs.git
cd container-b6o70hs
```
...
```
docker attach container-b6o70hs
```
